...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware('role:siswa')->prefix('siswa')->name('siswa.')->group(function () {
        ...
        Route::post('/presensi/checkout', [Student\AttendanceController::class, 'checkout'])->name('presensi.checkout');
    ...
    Route::middleware('role:admin')->prefix('admin')->name('admin.')->group(function () {
        ...
        // Izin Terlambat
        Route::get('/izin-terlambat',        [Admin\LatePermissionController::class, 'index'])  ->name('izin-terlambat');
        Route::patch('/izin-terlambat/{id}', [Admin\LatePermissionController::class, 'approve'])->name('izin-terlambat.approve');
